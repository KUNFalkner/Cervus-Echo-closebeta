...
const LoginPage = ({onLogin,onSwitchRegister}) => {
  ...
  return <div className="login-page"><div className="login-card-glass"><div className="login-header"><span className="login-icon"><svg className="brand-deer" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><defs><linearGradient id="deerGold" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stopColor="#f0d79a"/><stop offset="1" stopColor="#b8860b"/></linearGradient></defs><g stroke="url(#deerGold)" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round"><path d="M86 52 C98 60 98 72 86 80" opacity="0.9"/><path d="M97 46 C113 58 113 74 97 86" opacity="0.5"/><path d="M50 40 C46 28 44 20 42 10"/><path d="M46 26 L34 20"/><path d="M44 18 L32 14"/><path d="M70 40 C74 28 76 20 78 10"/><path d="M74 26 L86 20"/><path d="M76 18 L88 14"/><path d="M46 44 C36 40 30 46 32 54"/><path d="M74 44 C84 40 90 46 88 54"/><path d="M50 42 C42 44 38 56 42 70 C45 80 54 86 60 86 C66 86 75 80 78 70 C82 56 78 44 70 42 C64 40 56 40 50 42 Z"/><circle cx="52" cy="58" r="2.6" fill="url(#deerGold)" stroke="none"/><circle cx="68" cy="58" r="2.6" fill="url(#deerGold)" stroke="none"/></g></svg></span><h1 className="brand-title">鹿鸣回音</h1><span className="brand-subtitle-en">Cervus Echo</span><p>匿名表达，自由交流</p></div><form onSubmit={submit} className="login-form"><input ref={nameRef} type="text" placeholder="用户名" className="login-input" required/><input ref={passRef} type="password" placeholder="密码（可选）" className="login-input"/><button type="submit" className="login-btn" disabled={loading}>{loading?'进入中...':'进入社区'}</button></form><p className="switch-link">没有账号？<button onClick={onSwitchRegister}>去注册</button></p></div></div>
}
